...
export const en: Record<string, string> = {
  ...
  'domain.notReady': 'operator setup required',

  // ── Community lifts ─────────────────────────────────
  'lift.passengersTitle': 'Passengers and drop-offs',
  'lift.passengersHint': 'Add each passenger in the order they will be dropped off. Everyone meets at the same pickup.',
  'lift.passengerNumber': 'Passenger {n}',
  'lift.passengerName': 'Passenger {n} name',
  'lift.passengerNamePlaceholder': 'Passenger name',
  'lift.guardianName': 'Passenger {n} receiving guardian',
  'lift.guardianPlaceholder': 'Receiving guardian (optional)',
  'lift.guardian': 'Receiving guardian',
  'lift.dropoff': 'Drop-off {n}',
  'lift.lastDropoff': 'Last drop-off',
  'lift.searchDropoff': 'Search for this passenger’s drop-off',
  'lift.addPassenger': '+ Add an earlier drop-off',
  'lift.removePassenger': 'Remove passenger {n}',
  'lift.codePrivacy': 'A private four-digit code is made on this phone for every handoff. The driver never sees it in advance.',
  'lift.noPayment': 'No payment needed',
  'lift.noPaymentCompleted': 'Shared lift — no money changed hands',
  'lift.passengerCount': '{n} passengers',
  'lift.todayLifts': 'Lifts today',
  'lift.dropoffProgress': 'Passenger drop-offs',
  'lift.shareCodeHint': 'Share each code only with that passenger’s receiving guardian.',
  'lift.handoffCode': 'Handoff code',
  'lift.handoffCodeFor': 'Handoff code for {name}',
  'lift.codePlaceholder': '0000',
  'lift.arrivedFor': 'Arrived for {name}',
  'lift.confirmHandoff': 'Confirm {name} handoff',
  'lift.nextDropoff': 'Next drop-off — {name}',
  'lift.status.pending': 'Next: not yet reached',
  'lift.status.arrived': 'Driver has arrived — share the code',
  'lift.status.handed_off': 'Handoff confirmed',
  'lift.createReplacement': 'Create replacement code',
  'lift.replacementCreated': 'Replacement handoff code created',
  'lift.replacementFailed': 'Could not replace the handoff code',
