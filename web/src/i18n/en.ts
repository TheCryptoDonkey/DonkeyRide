...
export const en: Record<string, string> = {
  ...
  'profile.accountIdTreeNote': 'Safe to share. This ID is separate from your other role and from identities used with other operators.',
  ...
  'profile.identitySeparation': 'Identity separation',
  'profile.treeActive': 'Private identity tree active',
  'profile.treeNote': 'Rider, driver and each selected operator get unlinkable identities from one unpublished root. Temporary shift, journey and gift-wrap keys are still random.',
  'profile.legacyActive': 'Existing identity preserved',
  'profile.legacyNote': 'This installation keeps its existing account ID so ratings and contacts are not silently lost. Starting fresh changes both rider and driver IDs.',
  'profile.treeStartFresh': 'Start fresh with private identities',
  'profile.treeFreshWarning': 'Back up your current recovery key first. Continuing permanently replaces the rider and driver identities used by this installation; old ratings will not follow automatically.',
  'profile.treeFinishFirst': 'Finish or cancel the active journey before changing identities.',
  'profile.treeConfirmFresh': 'Replace both identities',
  'profile.treeRecoveryNote': 'This unpublished root restores every DonkeyRide role and operator identity on this device. Anyone with it can derive all of them. Store it offline or in a password manager; never share it.',
  'profile.treeRestoreNote': 'Paste the unpublished tree recovery key from another device. This replaces every derived DonkeyRide identity here, not just the ID shown above.',
  'profile.treeReplace': 'Replace all identities on this device',
  ...
  'settle.short': 'Their proof covers {paid} sats, but the fare is {owed} sats. Check you received the full amount before confirming.',
  ...
  'pay.nwcBudgetWarning': 'This connection can spend from your wallet, and it stays on this device. Create it with a small budget or a single-payment limit in your wallet app.',
