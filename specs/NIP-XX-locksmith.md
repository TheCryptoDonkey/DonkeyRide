...
- **[NIP-XX-discovery.md](NIP-XX-discovery.md)** — Service discovery (geohash-based locksmith matching)
- **[NIP-XX-disputes.md](NIP-XX-disputes.md)** — Dispute resolution (pricing and workmanship disputes)
- **[NIP-XX-safety.md](NIP-XX-safety.md)** — Safety infrastructure (vulnerability of lockout situations)
